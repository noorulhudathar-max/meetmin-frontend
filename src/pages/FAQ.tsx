...
//         padding:'18px 22px', cursor:'pointer', gap:14,
//         background:'transparent', border:'none',
//         fontWeight:600, fontSize:15, fontFamily:'var(--font-head)',
//         /* Question text: bright white always */
...
//         }}>+</div>
//       </button>
//       <div style={{ maxHeight: open ? 280 : 0, overflow:'hidden', transition:'max-height 0.4s cubic-bezier(0.16,1,0.3,1)' }}>
//         {/* Answer text: high-contrast light lavender, NOT the dim purple-light */}
//         <p style={{ fontSize:14, color:'rgba(220,215,255,0.85)', lineHeight:1.75, padding:'0 22px 20px' }}>{a}</p>
//       </div>
//     </div>
//   )
// }
...
//         <h1 style={{ fontFamily:'var(--font-head)', fontSize:'clamp(28px,5vw,46px)', fontWeight:800, lineHeight:1.1, marginBottom:12, color:'rgba(245,243,255,0.97)' }}>
//           Got questions?<br />
...
//         </h1>
//         <p style={{ fontSize:14, color:'rgba(210,205,255,0.75)', lineHeight:1.7, maxWidth:500, marginBottom:22 }}>
...
//         {FAQ_DATA.map(group => (
//           <div key={group.cat}>
//             {/* Category label — bright enough to read clearly */}
//             <div style={{
...
//       {/* Bottom CTA */}
//       <div style={{
//         marginTop:52, background:'rgba(100,87,249,0.08)',
//         border:'1px solid rgba(100,87,249,0.2)',
//         borderRadius:18, padding:'32px 28px',
//         display:'flex', justifyContent:'space-between', alignItems:'center', gap:20, flexWrap:'wrap',
//       }}>
//         <div>
//           <h3 style={{ fontFamily:'var(--font-head)', fontSize:18, fontWeight:700, marginBottom:6, color:'rgba(245,243,255,0.97)' }}>Still have questions?</h3>
//           <p style={{ color:'rgba(210,205,255,0.72)', fontSize:13 }}>Our team responds within 24 hours.</p>
//         </div>
