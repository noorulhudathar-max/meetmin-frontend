...
//         ;(e.currentTarget as HTMLDivElement).style.border = `1px solid ${color}44`
//         ;(e.currentTarget as HTMLDivElement).style.boxShadow = `0 20px 40px ${color}22`
//       }}
//       onMouseLeave={e => {
...
//       <div style={{ fontSize: '36px', fontWeight: '800', color: 'white', letterSpacing: '-1px', lineHeight: 1 }}>
//         {count}{suffix}
//       </div>
//       <div style={{ fontSize: '13px', color: 'rgba(255,255,255,0.5)', marginTop: '6px', fontWeight: '500' }}>{label}</div>
//       {trend && (
//         <div style={{ marginTop: '10px', fontSize: '12px', color: '#4ade80', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '4px' }}>
//           <span>↑</span>{trend}
//         </div>
//       )}
//     </div>
...
//         ctx.fillStyle = `rgba(139, 127, 247, ${p.o})`
//         ctx.fill()
//       })
//       // Draw connections
...
//             ctx.moveTo(p.x, p.y)
//             ctx.lineTo(q.x, q.y)
//             ctx.strokeStyle = `rgba(139, 127, 247, ${0.08 * (1 - d / 80)})`
//             ctx.stroke()
//           }
//         })
//       })
...
//         minutesGenerated: done.length,
//         hoursSaved: Math.round(totalMinutes / 60 * 10) / 10 || done.length * 0.5,
...
//     pending: '#f59e0b', processing: '#3b82f6', done: '#22c55e', failed: '#ef4444'
//   }
...
//       <div style={{ position: 'fixed', top: '50%', left: '60%', width: '400px', height: '400px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(34,197,94,0.05) 0%, transparent 70%)', pointerEvents: 'none', zIndex: 0 }} />

//       {/* Main content */}
//       <div style={{ position: 'relative', zIndex: 1, padding: 'clamp(16px, 3vw, 32px)' }}>
...
//         }}>
//           <div>
//             <div style={{ fontSize: 'clamp(20px, 3vw, 28px)', fontWeight: '800', color: 'white', letterSpacing: '-0.5px' }}>
...
//               background: 'rgba(100,87,249,0.15)', border: '1px solid rgba(100,87,249,0.3)',
//               color: '#a5b4fc', padding: '10px 18px', borderRadius: '12px',
...
//               border: 'none', color: 'white', padding: '10px 20px', borderRadius: '12px',
//               fontSize: '13px', fontWeight: '700', cursor: 'pointer',
//               display: 'flex', alignItems: 'center', gap: '6px',
//               boxShadow: '0 8px 24px rgba(100,87,249,0.4)',
//               transition: 'all 0.2s'
//             }}
//               onMouseEnter={e => { (e.currentTarget as HTMLButtonElement).style.transform = 'translateY(-2px)'; (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 12px 32px rgba(100,87,249,0.5)' }}
//               onMouseLeave={e => { (e.currentTarget as HTMLButtonElement).style.transform = 'translateY(0)'; (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 8px 24px rgba(100,87,249,0.4)' }}
...
//         {/* ── Hero banner ── */}
//         <div style={{
//           background: 'linear-gradient(135deg, rgba(100,87,249,0.3) 0%, rgba(139,127,247,0.15) 50%, rgba(34,197,94,0.1) 100%)',
//           border: '1px solid rgba(100,87,249,0.2)',
//           borderRadius: '24px', padding: 'clamp(20px, 3vw, 36px)',
...
//           <div style={{ zIndex: 1 }}>
//             <h2 style={{ color: 'white', fontSize: 'clamp(18px, 2.5vw, 26px)', fontWeight: '800', margin: '0 0 8px', letterSpacing: '-0.5px', lineHeight: 1.2 }}>
//               Turn meetings into<br />actionable minutes with AI ✨
//             </h2>
//             <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: 'clamp(12px, 1.5vw, 14px)', margin: '0 0 20px' }}>
//               Upload, transcribe and summarize your meetings in seconds.
//             </p>
//             <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
//               <button onClick={() => setShowUpload(true)} style={{
//                 background: 'white', color: '#6457F9', border: 'none',
...
//           {/* 3D floating card */}
//           <div style={{
//             background: 'rgba(255,255,255,0.08)', borderRadius: '16px', padding: '20px',
//             width: 'clamp(120px, 15vw, 160px)', backdropFilter: 'blur(20px)',
...
//                 background: `rgba(139,127,247,${0.3 + i * 0.1})`,
//                 width: `${w}%`, transition: 'width 0.5s ease'
//               }} />
//             ))}
//             <div style={{ marginTop: '14px', display: 'flex', gap: '6px' }}>
//               {['#6457F9', '#22c55e', '#f59e0b'].map((c, i) => (
//                 <div key={i} style={{ width: '20px', height: '20px', borderRadius: '50%', background: c, border: '2px solid rgba(255,255,255,0.2)' }} />
//               ))}
//             </div>
//           </div>
//         </div>
...
//           <StatCard icon="🎯" label="Completed Tasks" value={stats.completedItems} color="#8b5cf6" delay={600} />
//           <StatCard icon="⚡" label="Pending Tasks" value={stats.pendingItems} color="#ef4444" delay={700} />
//         </div>
...
//               <h3 style={{ margin: 0, fontSize: '16px', fontWeight: '700', color: 'white' }}>Recent Meetings</h3>
//               <button onClick={() => navigate('/meetings')} style={{
//                 background: 'rgba(100,87,249,0.15)', border: 'none', color: '#a5b4fc',
...
//                 <p style={{ margin: 0, fontSize: '14px' }}>No meetings yet. Upload your first one!</p>
//               </div>
//             ) : (
...
//                     onMouseEnter={e => {
//                       (e.currentTarget as HTMLDivElement).style.background = 'rgba(100,87,249,0.08)'
//                       ;(e.currentTarget as HTMLDivElement).style.borderColor = 'rgba(100,87,249,0.2)'
//                     }}
//                     onMouseLeave={e => {
...
//                         background: `${statusColor[m.status] || '#6b7280'}22`,
//                         border: `1px solid ${statusColor[m.status] || '#6b7280'}44`,
//                         display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '16px'
//                       }}>
//                         {m.status === 'done' ? '✅' : m.status === 'processing' ? '⏳' : m.status === 'failed' ? '❌' : '📋'}
//                       </div>
//                       <div style={{ minWidth: 0 }}>
//                         <div style={{ fontSize: '13.5px', fontWeight: '600', color: 'white', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', maxWidth: '280px' }}>{m.title}</div>
...
//             borderRadius: '20px', padding: '24px', backdropFilter: 'blur(20px)'
//           }}>
//             <h3 style={{ margin: '0 0 20px', fontSize: '16px', fontWeight: '700', color: 'white' }}>Task Progress</h3>
...
//                       <stop offset="0%" stopColor="#6457F9" />
...
//                 }}>
//                   <span style={{ fontSize: '24px', fontWeight: '800', color: 'white' }}>{completionPct}%</span>
...
//             {[
//               { label: 'Completed', value: stats.completedItems, total: stats.actionItems, color: '#22c55e' },
//               { label: 'Pending', value: stats.pendingItems, total: stats.actionItems, color: '#f59e0b' },
//             ].map(item => (
//               <div key={item.label} style={{ marginBottom: '14px' }}>
//                 <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
//                   <span style={{ fontSize: '12.5px', color: 'rgba(255,255,255,0.6)', fontWeight: '500' }}>{item.label}</span>
//                   <span style={{ fontSize: '12.5px', color: 'white', fontWeight: '700' }}>{item.value}</span>
//                 </div>
//                 <MiniBar value={item.value} max={Math.max(item.total, 1)} color={item.color} />
//               </div>
//             ))}

//             <button onClick={() => navigate('/action-items')} style={{
//               width: '100%', marginTop: '16px', padding: '10px',
//               background: 'rgba(100,87,249,0.15)', border: '1px solid rgba(100,87,249,0.3)',
//               color: '#a5b4fc', borderRadius: '10px', fontSize: '13px',
...
//             borderRadius: '20px', padding: '24px', backdropFilter: 'blur(20px)'
//           }}>
//             <h3 style={{ margin: '0 0 20px', fontSize: '16px', fontWeight: '700', color: 'white' }}>Quick Actions</h3>
//             <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
//               {[
...
//                   }}>{item.icon}</div>
//                   <div>
//                     <div style={{ fontSize: '13.5px', fontWeight: '600', color: 'white' }}>{item.label}</div>
//                     <div style={{ fontSize: '11.5px', color: 'rgba(255,255,255,0.4)', marginTop: '2px' }}>{item.sub}</div>
//                   </div>
//                 </button>
//               ))}
//             </div>
...
//             border: '1px solid rgba(100,87,249,0.3)',
//             borderRadius: '24px', padding: '32px',
//             width: '100%', maxWidth: '440px',
//             boxShadow: '0 40px 80px rgba(0,0,0,0.6), 0 0 0 1px rgba(100,87,249,0.1)'
//           }}>
//             <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
//               <h3 style={{ margin: 0, fontSize: '18px', fontWeight: '700', color: 'white' }}>Upload Meeting</h3>
//               <button onClick={() => { setShowUpload(false); setUploadFile(null) }} style={{
...
//               border: `2px dashed ${uploadFile ? '#6457F9' : 'rgba(255,255,255,0.1)'}`,
//               borderRadius: '16px', padding: '40px 20px', textAlign: 'center',
//               cursor: 'pointer', background: uploadFile ? 'rgba(100,87,249,0.1)' : 'rgba(255,255,255,0.02)',
//               marginBottom: '16px', transition: 'all 0.2s'
//             }}>
//               <div style={{ fontSize: '40px', marginBottom: '12px' }}>🎙</div>
//               <p style={{ margin: '0 0 6px', fontWeight: '600', color: 'white', fontSize: '14px' }}>
//                 {uploadFile ? `✅ ${uploadFile.name}` : 'Click to select audio or video'}
//               </p>
//               <p style={{ margin: 0, fontSize: '12px', color: 'rgba(255,255,255,0.4)' }}>MP3, MP4, WAV, M4A — max 500MB</p>
//               <input id="dash-file" type="file" accept="audio/*,video/*"
//                 onChange={e => setUploadFile(e.target.files?.[0] || null)}
//                 style={{ display: 'none' }} />
//             </div>

//             <div style={{ marginBottom: '16px' }}>
//               <label style={{ fontSize: '12.5px', color: 'rgba(255,255,255,0.5)', display: 'block', marginBottom: '7px', fontWeight: '500' }}>Audio Language</label>
...
//               background: uploadFile && !uploading ? 'linear-gradient(135deg, #6457F9, #8B7FF7)' : 'rgba(255,255,255,0.08)',
//               color: uploadFile && !uploading ? 'white' : 'rgba(255,255,255,0.3)',
//               border: 'none', fontSize: '14px', fontWeight: '700',
//               cursor: uploadFile && !uploading ? 'pointer' : 'not-allowed',
//               boxShadow: uploadFile && !uploading ? '0 8px 24px rgba(100,87,249,0.4)' : 'none'
//             }}>
