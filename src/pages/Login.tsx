...
//         }}>N</div>
//         <span style={{ fontFamily:'var(--font-head)', fontWeight:700, fontSize:17, color:'var(--text)', letterSpacing:'-0.01em' }}>
//         {' '}
...
//         fontSize:11, fontWeight:600, color:'rgba(210,205,255,0.8)',
//         letterSpacing:'0.06em', textTransform:'uppercase',
//         whiteSpace:'nowrap',
//       }}>
//         <span style={{ width:6, height:6, borderRadius:'50%', background:'#6dffb3', display:'inline-block', boxShadow:'0 0 5px #6dffb3', animation:'pulse 2s infinite' }} />
...
//   return (
//     <>
//       <div style={{ ...b, width:420, height:420, background:'rgba(100,87,249,0.15)', top:-100, right:-100, animation:'drift 20s ease-in-out infinite alternate' }} />
//       <div style={{ ...b, width:320, height:320, background:'rgba(139,127,247,0.10)', bottom:-80, left:-80, animation:'drift 17s ease-in-out infinite alternate', animationDelay:'-7s' }} />
//       <div style={{ ...b, width:220, height:220, background:'rgba(80,200,255,0.06)', top:'42%', left:'33%', animation:'drift 22s ease-in-out infinite alternate', animationDelay:'-13s' }} />
//     </>
//   )
// }
...
//     borderRadius:14, padding:'15px 18px', backdropFilter:'blur(12px)',
//     minWidth:200, maxWidth:235, ...ex,
//   })
//   const row = (t: string) => (
//     <div key={t} style={{ display:'flex', alignItems:'center', gap:8, marginBottom:5 }}>
//       <div style={{ width:16, height:16, borderRadius:4, background:'rgba(100,87,249,0.3)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:8, color:'#c4b8ff', flexShrink:0 }}>✓</div>
//       <span style={{ fontSize:11, color:'rgba(220,215,255,0.6)' }}>{t}</span>
//     </div>
//   )
//   const ttl = (t: string) => <div style={{ fontSize:11, fontWeight:700, color:'rgba(220,215,255,0.75)', marginBottom:9, fontFamily:'var(--font-head)' }}>{t}</div>
//   return (
//     <div className="ambient-card" style={{ position:'fixed', inset:0, pointerEvents:'none', zIndex:1, overflow:'hidden' }}>
...
//       <label style={{ display:'block', fontSize:11, fontWeight:700, color:'rgba(200,195,255,0.75)', marginBottom:6, letterSpacing:'0.05em', textTransform:'uppercase' }}>
//         {label}
//       </label>
//       <input
...
//       borderRadius:22, padding:'34px 32px 28px',
...
//     }}
//     onMouseEnter={e => (e.currentTarget as HTMLDivElement).style.boxShadow='0 0 0 1px rgba(100,87,249,0.25), 0 40px 80px rgba(0,0,0,0.65), inset 0 1px 0 rgba(255,255,255,0.12)'}
//     onMouseLeave={e => (e.currentTarget as HTMLDivElement).style.boxShadow='0 0 0 1px rgba(100,87,249,0.12), 0 28px 70px rgba(0,0,0,0.6), inset 0 1px 0 rgba(255,255,255,0.1)'}
//     >
//       {/* Brand */}
//       <div style={{ display:'flex', alignItems:'center', gap:9, marginBottom:20 }}>
//         <div style={{ width:30, height:30, borderRadius:8, background:'linear-gradient(135deg,#6457F9,#9B8EFF)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:14, boxShadow:'0 3px 12px rgba(100,87,249,0.4)' }}>📋</div>
//         <span style={{ fontFamily:'var(--font-head)', fontSize:15, fontWeight:700, color:'rgba(240,238,255,0.95)' }}>
//          <span style={{ background:'linear-gradient(90deg,#8B7FF7,#c4b8ff)', WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent' }}> Notivo AI</span>
//         </span>
//       </div>

//       <h1 style={{ fontFamily:'var(--font-head)', fontSize:24, fontWeight:700, marginBottom:5, color:'rgba(245,243,255,0.97)' }}>
//         {isSignUp ? 'Create account' : 'Welcome back'}
//       </h1>
//       <p style={{ fontSize:13, color:'rgba(190,185,255,0.75)', marginBottom:22, lineHeight:1.55 }}>
...
//         }}
//         onMouseEnter={e => { if (!loading) { const b = e.currentTarget as HTMLButtonElement; b.style.transform='translateY(-2px)'; b.style.boxShadow='0 7px 26px rgba(100,87,249,0.6)' }}}
//         onMouseLeave={e => { const b = e.currentTarget as HTMLButtonElement; b.style.transform=''; b.style.boxShadow='0 4px 18px rgba(100,87,249,0.45)' }}
//         >
...
//       }}
//       onMouseEnter={e => { const b = e.currentTarget as HTMLButtonElement; b.style.background='rgba(255,255,255,0.1)'; b.style.borderColor='rgba(255,255,255,0.2)' }}
//       onMouseLeave={e => { const b = e.currentTarget as HTMLButtonElement; b.style.background='rgba(255,255,255,0.06)'; b.style.borderColor='rgba(255,255,255,0.12)' }}
//       >
//         <GoogleIcon /> Continue with Google
//       </button>

//       <p style={{ textAlign:'center', fontSize:12, color:'rgba(190,185,255,0.65)' }}>
...
//       <p style={{ textAlign:'center', fontSize:11, color:'rgba(190,185,255,0.45)', marginTop:11 }}>
//         Have questions?{' '}
...
//   return (
//     <div style={{ display:'flex', justifyContent:'center', gap:8, marginTop:16, flexWrap:'wrap', maxWidth:420 }}>
//       {pills.map((p, i) => (
//         <div key={p} style={{
//           display:'flex', alignItems:'center', gap:6,
//           background:'rgba(255,255,255,0.05)', border:'1px solid rgba(255,255,255,0.1)',
//           borderRadius:100, padding:'6px 14px', fontSize:11, color:'rgba(200,195,255,0.72)',
//           animation:'floatIn 0.7s ease both', animationDelay:`${0.2+i*0.08}s`,
//         }}>
//           <div style={{ width:5, height:5, borderRadius:'50%', background:'#a89fff', animation:'pulse 2s infinite' }} />
//           {p}
//         </div>
//       ))}
//     </div>
