...
//         <h1 style={{ margin:'0 0 4px', fontSize:20, fontWeight:700, color:'#f0f0ff' }}>Action Items</h1>
...
//           }}>
//             <div style={{ width:36, height:36, borderRadius:10, background:card.bg, display:'flex', alignItems:'center', justifyContent:'center', fontSize:17, marginBottom:12 }}>{card.icon}</div>
...
//           )}
//         </div>
//         <div style={{ display:'flex', gap:3, background:'rgba(255,255,255,0.04)', padding:4, borderRadius:10, border:'1px solid rgba(255,255,255,0.07)', flexShrink:0 }}>
...
//                       style={{ padding:'10px 14px', borderRadius:8, border:'1px solid rgba(100,87,249,0.5)', fontSize:13, outline:'none', background:'rgba(255,255,255,0.06)', color:'#f0f0ff' }} />
//                     <div style={{ display:'flex', gap:10 }}>
//                       <input value={editAssignee} onChange={e => setEditAssignee(e.target.value)} placeholder="👤 Assignee"
//                         style={{ flex:1, padding:'9px 14px', borderRadius:8, border:'1px solid rgba(255,255,255,0.1)', fontSize:12, outline:'none', background:'rgba(255,255,255,0.05)', color:'#f0f0ff' }} />
...
//                     {/* Content */}
//                     <div style={{ flex:1 }}>
//                       <p style={{ margin:'0 0 8px', fontSize:13.5, fontWeight:500, color:item.is_completed?'rgba(240,240,255,0.3)':'#f0f0ff', textDecoration:item.is_completed?'line-through':'none', lineHeight:1.5 }}>{item.task}</p>
